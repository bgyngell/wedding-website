...
const Privacy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Robbie Gyngell Wedding Music</title>
        <meta
          name="description"
          content="Learn how we collect, use and protect personal information when you enquire or book wedding music services."
        />
        <link
          rel="canonical"
          href="https://robbiegyngellweddings.com/privacy"
        />
        <meta
          property="og:title"
          content="Privacy Policy | Robbie Gyngell Wedding Music"
        />
        <meta
            ...
            <div className="space-y-8">
              ...
              <Card>
                ...
                <CardContent className="space-y-4 font-sans text-muted-foreground">
                  <p>
                    When you submit a booking request through our website, we
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>
                      Any special requests or preferences you share with us
                    </li>
                  </ul>
                  <p>
                    We also automatically collect basic technical information
                    such as your IP address, browser type, and pages visited to
              ...
              <Card>
                ...
                <CardContent className="space-y-4 font-sans text-muted-foreground">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>
                      Responding to your booking inquiries and event planning
                      needs
                    </li>
                    <li>
                      Coordinating wedding music services and event details
                    </li>
                    <li>
                      Sending contract information and booking confirmations
                    </li>
                    <li>
                  ...
                  <p>
                    We will never use your information for unsolicited marketing
              ...
              <Card>
                ...
                <CardContent className="space-y-4 font-sans text-muted-foreground">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    <li>
                      Secure data transmission using industry-standard
                      encryption
                    </li>
                    <li>
                    ...
                    <li>
                      Secure storage of all client information and
                      communications
                    </li>
                  </ul>
                  <p>
                    ...
                    encourage you to contact us with any security concerns.
                  </p>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4 font-sans text-muted-foreground">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>
                      ...
                      website or conducting our business, under strict
                      confidentiality agreements
                    </li>
                    <li>
                      With wedding planners or venue coordinators when you
                      explicitly request us to do so for your event
                    </li>
                  </ul>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent className="space-y-4 font-sans text-muted-foreground">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>
                      Performance cookies to improve loading times and user
                      experience
                    </li>
                  </ul>
                  <p>
              ...
              <Card>
                ...
                <CardContent className="space-y-4 font-sans text-muted-foreground">
                  ...
                  <ul className="list-disc list-inside space-y-2 ml-4">
                    ...
                    <li>
                      Withdraw consent for processing your information at any
                      time
                    </li>
                    <li>
                ...
                <CardContent className="space-y-4 font-sans text-muted-foreground">
                  ...
                  <div className="bg-muted p-4 rounded-lg">
                    <p className="font-medium text-foreground">
                      Robbie Gyngell - Wedding Musician
                    </p>
                  ...
                  <p className="text-sm">
                    ...
                    {new Date().toLocaleDateString()} and may be updated
