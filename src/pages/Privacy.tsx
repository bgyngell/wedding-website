          ...
          <div className="space-y-8">
            ...
            <Card>
              ...
              <CardContent className="space-y-4 font-sans text-muted-foreground">
                ...
                <p>
                  We also automatically collect basic technical information such
                  as your IP address, browser type, and pages visited to improve
                  our website performance and user experience.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4 font-sans text-muted-foreground">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>
                    Secure storage of all client information and communications
                  </li>
                </ul>
                <p>
            ...
            <Card>
              ...
              <CardContent className="space-y-4 font-sans text-muted-foreground">
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <li>
                    Withdraw consent for processing your information at any time
                  </li>
                  <li>
