...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-rose-blush via-lavender-mist to-sage-green py-20 px-4">
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-dusty-pink to-sage-green rounded-lg flex items-center justify-center">
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-lavender-mist to-cream-white">
        <div className="container mx-auto">
          <BookingForm />
        </div>
      </section>
