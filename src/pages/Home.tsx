...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-warm-sand via-cream-white to-warm-sand py-20 px-4">
        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-warm-sand to-cream-white rounded-lg flex items-center justify-center">
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-warm-sand to-cream-white">
        <div className="container mx-auto">
          <BookingForm />
        </div>
      </section>
