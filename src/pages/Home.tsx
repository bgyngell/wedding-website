            ...
            <div>
              ...
              <div className="space-y-4 font-sans text-muted-foreground">
                <p>
                  ...
                  discovered his passion for music at an early age. The sound of
                  waves and the laid-back beach culture deeply influenced his
                  musical style, creating a unique blend of warmth and
                  sophistication.
                </p>
                <p>
                  ...
                  giving him the versatility to adapt to any wedding atmosphere.
                </p>
                <p>
                  As both a solo artist and accomplished band member, Robbie has
                  performed at hundreds of weddings and events throughout
                  Australia. His deep understanding of how music shapes special
                  moments makes him the perfect choice for couples seeking that
      ...
      <section className="py-16 px-4 bg-colour-2">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="font-sans text-muted-foreground max-w-2xl mx-auto">
              Choose any combination of services to create your perfect wedding
              soundtrack. All services available with or without professional PA
              system.
            </p>
          </div>
